    ...
    <div className="relative w-full h-64 flex items-center justify-center overflow-hidden">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col items-center">
          <div className="bg-foreground text-background text-sm font-bold px-3 py-2 rounded shadow-lg">
            {period}
          </div>
        </div>
        ...
        <div className="flex gap-2">
          {formatNumber(displayHours).split('').map((digit, index) => (
            <div
              key={`hour-${index}`}
              className={`relative bg-foreground text-background text-7xl font-bold px-6 py-8 rounded-lg shadow-2xl ${
        ...
        {/* Colon */}
        <div className="text-7xl font-bold text-foreground pb-2">:</div>
